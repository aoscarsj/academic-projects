...
public class TelaLogAluno extends JFrame implements ActionListener {
	...
	private JMenuItem mitVerNotas, mitFazerProva, mitSair;
	...
	private void setAddAll(){
		...
		MenuOpcoes.add(mitFazerProva);
		MenuOpcoes.add(mitSair);
		
		mitVerNotas.addActionListener(this);
		mitFazerProva.addActionListener(this);
	...
	private void setVar(){
		...
		mitFazerProva = new JMenuItem("Fazer Prova");
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (event.getSource() == mitSair)
			this.dispose();
		else if(event.getSource() == mitFazerProva){
